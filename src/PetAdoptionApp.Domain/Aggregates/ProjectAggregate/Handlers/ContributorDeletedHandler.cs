using MediatR;
using PetAdoptionApp.Domain.Aggregates.ProjectAggregate.Specifications;
using PetAdoptionApp.Domain.Aggregates.ContributorAggregate.Events;
using PetAdoptionApp.SharedKernel.Interfaces;

namespace PetAdoptionApp.Domain.Aggregates.ProjectAggregate.Handlers;
